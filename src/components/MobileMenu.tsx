      ...
      <div className="flex items-center justify-around">
        <Link 
          ...
          className={`flex flex-col items-center p-2 ${
            isActive('/games') && !isActive('/games/new')
              ? "text-phase10-blue dark:text-phase10-lightBlue" 
              : "text-gray-600 dark:text-gray-300 hover:text-phase10-blue dark:hover:text-phase10-lightBlue"
          }`}
        >
          <Home size={24} />
